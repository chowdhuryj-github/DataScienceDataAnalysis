...
% Optional: reduce space around figures
\setlength{\intextsep}{0pt}  % Reduce space above and below figures
\setlength{\textfloatsep}{5pt} % Reduce space between text and figures

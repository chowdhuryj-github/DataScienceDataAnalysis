...
In [Week 2](C:\GitHub\DataScienceDataAnalysis\wk_02\lab\Lab_2_JIC.pdf), I explored the data science process. The process works where we start off with a dataset and explore it to identify any patterns. When we discover
...
In [Week 3](C:\GitHub\DataScienceDataAnalysis\wk_03\tex\Lab_3_JIC.pdf), I explored different methods of data visualization. I learnt about the which type of graphs are appropriate to use, and that means knowing the 
...
In [Week 4](C:\GitHub\DataScienceDataAnalysis\wk_04\tex\Lab_4_JIC.pdf), I explored the bootstrapping process, as well as understanding what confidence intervals are. Bootstrapping is done in three steps, where we sample
...
In [Week 6](C:\GitHub\DataScienceDataAnalysis\wk_06\tex\Lab_5_JIC.pdf), I looked more at understanding family-wise error. This means knowing how to calculate the probability of getting at least one false positive. I 
...
In [Week 7](C:\GitHub\DataScienceDataAnalysis\wk_07\lab\Lab_6_JIC.pdf), I learnt about making data cards, which is a number of cards that provides a comprehensive summary of the data sets being used. I also did a lab
